...
class WorkFlow(BasePage):
   ...
   def flow_set_suspicious_notebook(self):
       ...
       self.functions.select_first_option_from_dropdown(self.checkNotebookPage.dropdown_suspicious_reason(),self.checkNotebookPage.dropdown_suspicious_reason_list())
