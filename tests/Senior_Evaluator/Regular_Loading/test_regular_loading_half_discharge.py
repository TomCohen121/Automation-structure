...
@allure.story("Half Discharge Process for Regular Loading - Senior Evaluator")
@allure.description("Half Discharge Process")
def test_regular_loading_half_discharge(f, add_allure_attach, page):
    f.functions.check_if_loading_number_exist(regular_loading_sen_half_discharge_num, 'regular_loading_sen_half_discharge_num')
    #Dashboard
    f.workflow.navigation_to_loading_screen()

    #LoadingScreen
    f.functions.search_loading(regular_loading_sen_half_discharge_num)
