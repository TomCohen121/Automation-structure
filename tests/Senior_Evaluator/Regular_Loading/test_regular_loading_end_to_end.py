...
@allure.story("E2E Test for Regular Loading - Senior Evaluator")
...
def test_regular_loading_end_to_end(f, add_allure_attach, page):
   f.functions.check_if_loading_number_exist(regular_loading_sen_E2E_num,'regular_loading_sen_E2E_num')
   ...
   #LoadingScreen
   f.functions.search_loading(regular_loading_sen_E2E_num)
