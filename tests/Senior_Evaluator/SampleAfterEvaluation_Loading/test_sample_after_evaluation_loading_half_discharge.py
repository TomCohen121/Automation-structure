...
@allure.story("Half Discharge Process for Sample After Evaluation Loading - Regular Evaluator")
@allure.description("Half Discharge Process")
def test_sample_loading_half_discharge(f, add_allure_attach, page):
    f.functions.check_if_loading_number_exist(sample_loading_half_discharge_num, 'sample_loading_half_discharge_num')

    f.workflow.navigation_to_loading_screen()
    #LoadingScreen
    f.functions.search_loading(sample_loading_half_discharge_num)
