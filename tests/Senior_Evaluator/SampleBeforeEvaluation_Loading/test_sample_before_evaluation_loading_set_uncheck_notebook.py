...
@allure.story("Set Uncheck Notebook Test for Sample Before Evaluation Loading - Senior Evaluator")
...
def test_sample_loading_set_uncheck_notebook(f, add_allure_attach, page):
    f.functions.check_if_loading_number_exist(sample_loading_sen_set_unchecked_num, 'sample_loading_sen_set_unchecked_num')
    #Dashboard
    ...
    #LoadingScreen
    f.functions.search_loading(sample_loading_sen_set_unchecked_num)
