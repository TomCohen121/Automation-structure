...
def test_sample_loading_error_handling(f, add_allure_attach, page):
   f.functions.check_if_loading_number_exist(sample_loading_sen_error_num,'sample_loading_sen_error_num')
   # Dashboard
   f.workflow.navigation_to_loading_screen()

   # LoadingScreen
   f.functions.search_loading(sample_loading_sen_error_num)
