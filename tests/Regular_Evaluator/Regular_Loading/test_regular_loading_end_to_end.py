...
def test_regular_loading_end_to_end(from_page, add_allure_attach, page):
   ...
   table_avarage_grade_before = from_page["Functions"].number_to_float(from_page["PortionPage"].txt_table_avg_grade(2))
   ...
   table_notebook_grade_before = from_page["Functions"].number_to_float(from_page["NotebookPage"].txt_table_notebook_grade(2))
...
# #################################################################################################################################################################################
   ...
   from_page["Functions"].assert_equal_to(table_notebook_grade_before,from_page["WorkFlow"].notebook_grade,"The Notebook grade is incorrect")
   ...
   from_page["Functions"].assert_equal_to(table_avarage_grade_before,from_page["WorkFlow"].notebook_grade,"The Portion Average grade incorrect" )
