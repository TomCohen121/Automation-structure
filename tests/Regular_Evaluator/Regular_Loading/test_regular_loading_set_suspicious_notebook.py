...
def test_regular_loading_set_suspicious_notebook(f, add_allure_attach, page):
    ...
    #NotebookScreen
    f.functions.table_choose_a_row(2).click()
    f.functions.checkbox_is_checked(f.notebookPage.checkbox_notebook_suspicious_evaluation(2),expected_state=True)
    ...
    f.functions.assert_equal_to(stat_num_of_suspicious_notebook_before+1,stat_num_of_suspicious_notebooks_after, "Number of Suspicious notebooks is incorrect")
