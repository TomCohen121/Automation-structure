...
def test_regular_loading_set_suspicious_notebook(f, add_allure_attach, page):
    f.functions.check_if_loading_number_exist(regular_loading_reg_set_suspicious_num, 'regular_loading_reg_set_suspicious_num')
    #Dashboard
    f.workflow.navigation_to_loading_screen()

    #LoadingScreen
    f.functions.search_loading(regular_loading_reg_set_suspicious_num)
