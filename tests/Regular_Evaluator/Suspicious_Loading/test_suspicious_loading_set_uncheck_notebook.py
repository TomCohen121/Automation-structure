...
@allure.story("Set Uncheck Notebook Test for Suspicious Loading - Regular Evaluator")
...
def test_suspicious_loading_set_uncheck_notebook(f, add_allure_attach, page):
    f.functions.check_if_loading_number_exist(suspicious_number_E2E_set_uncheck_notebook, 'suspicious_number_E2E_set_uncheck_notebook')
    ...
    #LoadingScreen
    f.functions.search_loading(suspicious_number_E2E_set_uncheck_notebook)
    ...
    f.functions.popup_answer_law()
    f.functions.table_choose_a_row(2).click()
    notebook_status = f.suspiciousLoadingNotebookPage.txt_suspicious_notebook_status(2).strip()
