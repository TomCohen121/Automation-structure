...
def test_permissions_for_regular_evaluator(f, add_allure_attach, page):
    #Dashboard
    ...
    f.functions.assert_element_not_exists(f.permissions.btn_reset_loading_to_starting_state(),"The Button - החזר טעינה למצב התחלתי in Regular Loading")
