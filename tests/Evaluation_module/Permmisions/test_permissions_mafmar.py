...
@pytest.mark.permissions_mafmar
@allure.story("Permissions for Mafmar")
@allure.description("Checking Permissions for Mafmar")
def test_permissions_for_mafmar(f, add_allure_attach, page):
    #Dashboard
    ...
    f.functions.assert_element_not_exists(f.permissions.btn_delete_all_evaluations(),"The Button - מחק כלל הערכות במנה in Portion screen in Regular Loading")
    f.functions.assert_element_not_exists(f.permissions.btn_confirm_no_check(), "The Button - אשר אי בדיקה in Regular Loading")
    f.functions.assert_element_not_exists(f.permissions.btn_cancel_no_check(), "The Button - בטל אי בדיקה in Regular Loading")
    f.functions.table_choose_a_row(2).dblclick()

    # NotebookScreen
    f.functions.popup_answer_law()
    f.functions.assert_element_not_exists(f.permissions.btn_delete_notebook_evaluation(),"The Button - מחק בדיקת מחברת in Notebook Page in Regular Loading")
    f.functions.assert_element_exists(f.permissions.btn_end_notebook_evaluation(), "The Button - סיים בדיקת מנה in Regular Loading")
    f.functions.table_choose_a_row(2).dblclick()

    # CheckNotebookScreen
    f.functions.assert_element_not_exists(f.permissions.btn_delete_notebook_evaluation_check_notebook(), "The Button - מחק בדיקת מחברת in CheckNotebook Page in Regular Loading")
    f.functions.assert_element_exists(f.permissions.btn_student_adaptations(), "The Button - התאמות לתלמיד in Regular Loading")
    f.functions.assert_element_not_exists(f.permissions.btn_show_formats(), "The Button - הצג פורמטים in Regular Loading")
    ...
    f.functions.assert_element_not_exists(f.permissions.btn_save_and_end_notebook_test(),"The Button - שמור וסיים בדיקת מחברת in Regular Loading")
    ...
    f.functions.assert_element_not_exists(f.permissions.btn_delete_all_evaluations(), "The Button - מחק כלל הערכות במנה in Portion screen in Senior Loading")
    f.functions.assert_element_not_exists(f.permissions.btn_confirm_no_check(), "The Button - אשר אי בדיקה in Senior Loading")
    f.functions.assert_element_not_exists(f.permissions.btn_cancel_no_check(), "The Button - בטל אי בדיקה in Senior Loading")
    f.functions.table_choose_a_row(2).dblclick()

    #NotebookScreen
    f.functions.popup_answer_law()
    f.functions.assert_element_not_exists(f.permissions.btn_delete_notebook_evaluation(), "The Button - מחק בדיקת מחברת in Notebook Page in Senior Loading")
    f.functions.assert_element_exists(f.permissions.btn_end_notebook_evaluation(), "The Button - סיים בדיקת מנה in Senior Loading")
    f.functions.table_choose_a_row(2).dblclick()

    #CheckNotebookScreen
    f.functions.assert_element_not_exists(f.permissions.btn_delete_notebook_evaluation_check_notebook(), "The Button - מחק בדיקת מחברת in CheckNotebook Page in Senior Loading")
    f.functions.assert_element_exists(f.permissions.btn_student_adaptations(), "The Button - התאמות לתלמיד in Senior Loading")
    f.functions.assert_element_not_exists(f.permissions.btn_show_formats(), "The Button - הצג פורמטים in Senior Loading")
    f.functions.assert_element_not_exists(f.permissions.btn_uncheck_notebook(),"The Button - אי בדיקת מחברת in Senior Loading")
    f.functions.assert_element_not_exists(f.permissions.btn_suspicious_notebook(), "The Button - מחברת חשודה in Senior Loading")
    ...
    # PortionScreen
    f.functions.assert_element_not_exists(f.permissions.btn_half_discharge_loading(), "The Button - פריקה חלקית in Mismatch Loading")
    ...
    f.functions.assert_element_not_exists(f.permissions.btn_confirm_no_check(), "The Button - אשר אי בדיקה in Mismatch Loading")
    f.functions.assert_element_not_exists(f.permissions.btn_cancel_no_check(), "The Button - בטל אי בדיקה in Mismatch Loading")
    f.functions.table_choose_a_row(2).dblclick()
    ...
    f.functions.assert_element_not_exists(f.permissions.btn_student_adaptations(), "The Button - התאמות לתלמיד in Mismatch Loading")
    f.functions.assert_element_not_exists(f.permissions.btn_show_formats(), "The Button - הצג פורמטים in Mismatch Loading")
    f.functions.assert_element_not_exists(f.permissions.btn_uncheck_notebook(), "The Button - אי בדיקת מחברת in Mismatch Loading")
    f.functions.assert_element_not_exists(f.permissions.btn_suspicious_notebook(), "The Button - מחברת חשודה in Mismatch Loading")
    f.functions.assert_element_not_exists(f.permissions.btn_save_and_end_notebook_test(),"The Button - שמור וסיים בדיקת מחברת in Mismatch Loading")
    f.functions.assert_is_field_disabled(f.checkNotebookPage.field_question_number())
    f.breadcrumbs.btn_breadcrumbs_to_loadings_page().click()
    ...
    f.functions.assert_element_not_exists(f.permissions.btn_delete_all_evaluations(),"The Button - מחק כלל הערכות במנה in Portion screen in Suspicious Loading")
    f.functions.assert_element_not_exists(f.permissions.btn_confirm_no_check(), "The Button - אשר אי בדיקה in Suspicious Loading")
    f.functions.assert_element_not_exists(f.permissions.btn_cancel_no_check(), "The Button - בטל אי בדיקה in Suspicious Loading")
    f.functions.table_choose_a_row(2).dblclick()

    # NotebookScreen
    f.functions.popup_answer_law()
    f.functions.assert_element_not_exists(f.permissions.btn_delete_notebook_evaluation(), "The Button - מחק בדיקת מחברת in Notebook Page in Suspicious Loading")
    f.functions.assert_element_not_exists(f.permissions.btn_end_notebook_evaluation(), "The Button - סיים בדיקת מנה in Suspicious Loading")
    f.functions.table_choose_a_row(2).dblclick()

    # CheckNotebookScreen
    f.functions.assert_element_not_exists(f.permissions.btn_delete_notebook_evaluation_check_notebook(),"The Button - מחק בדיקת מחברת in CheckNotebook Page in Suspicious Loading")
    ...
    f.functions.assert_element_not_exists(f.permissions.btn_save_and_end_notebook_test(), "The Button - שמור וסיים בדיקת מחברת in Suspicious Loading")
    f.functions.assert_is_field_disabled(f.checkNotebookPage.field_question_number())
    f.breadcrumbs.btn_breadcrumbs_to_loadings_page().click()
    ...
    f.functions.assert_element_not_exists(f.permissions.btn_delete_all_evaluations(),"The Button - מחק כלל הערכות במנה in Portion screen in AfterAppeal Loading")
    f.functions.assert_element_not_exists(f.permissions.btn_confirm_no_check(), "The Button - אשר אי בדיקה in AfterAppeal Loading")
    f.functions.assert_element_not_exists(f.permissions.btn_cancel_no_check(), "The Button - בטל אי בדיקה in AfterAppeal Loading")
    f.functions.table_choose_a_row(2).dblclick()

    # NotebookScreen
    f.functions.popup_answer_law()
    f.functions.assert_element_not_exists(f.permissions.btn_delete_notebook_evaluation(),"The Button - מחק בדיקת מחברת in Notebook Page in AfterAppeal Loading")
    ...
    # CheckNotebookScreen
    f.functions.assert_element_not_exists(f.permissions.btn_delete_notebook_evaluation_check_notebook(),"The Button - מחק בדיקת מחברת in CheckNotebook Page in AfterAppeal Loading")
    f.functions.assert_element_not_exists(f.permissions.btn_student_adaptations(), "The Button - התאמות לתלמיד in AfterAppeal Loading")
    f.functions.assert_element_not_exists(f.permissions.btn_show_formats(), "The Button - הצג פורמטים in AfterAppeal Loading")
    f.functions.assert_element_not_exists(f.permissions.btn_uncheck_notebook(), "The Button - אי בדיקת מחברת in AfterAppeal Loading")
