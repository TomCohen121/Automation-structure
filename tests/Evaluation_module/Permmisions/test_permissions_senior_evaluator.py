...
@pytest.mark.permissions_senior_evaluator
@allure.story("Permissions for Senior Evaluator")
@allure.description("Checking Permissions for Senior Evaluator")
def test_permissions_for_senior_evaluator(f, add_allure_attach, page):
    #Dashboard
