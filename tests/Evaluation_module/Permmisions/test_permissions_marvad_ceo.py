...
@pytest.mark.permissions_maravad_ceo
@allure.story("Permissions for Maravad CEO")
@allure.description("Checking Permissions for Maravad CEO")
def test_permissions_for_maravad_ceo(f, add_allure_attach, page):
    #Dashboard
