...
@allure.story("Permissions for Evaluation Module")
@allure.description("Checking Permissions for Evaluation Module")
def test_permissions_for_evaluation_module(f, add_allure_attach, page):
