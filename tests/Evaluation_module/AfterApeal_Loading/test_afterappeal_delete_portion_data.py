...
def test_afterappeal_delete_portion_data(f, add_allure_attach, page):
    ...
    table_num_of_checked_notebooks = f.functions.number_to_int(f.portionPage.txt_table_num_of_checked_notebooks(2))
    f.functions.assert_equal_to(table_num_of_checked_notebooks,0, "Number of checked Notebooks is incorrect")
